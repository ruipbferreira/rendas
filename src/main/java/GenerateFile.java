...
import utils.WordCallback;
import utils.WordUtils;

public class GenerateFile extends JFrame {

	private static final long serialVersionUID = 3803013989916562819L;
									...
									WordUtils.generateWord(fractionsFromFile, templateFile, outputFile.getAbsolutePath(), propsWord, new WordCallback() {
										...
										public void execute() {
											int confirmed = JOptionPane.showConfirmDialog(GenerateFile.this, 
													"Gerados " + fractionsFromFile.size() + " documentos! Deseja fechar a aplicação?", 
